// ================================================//
// =======NINEKORN AKA STEVE CHASSÉ notes==========//
// =========Canada-Quebec-Rivière-du-Loup==========//
//======built by me, prior to or in january 2019===// it was probably available as internet cookies for facebook and google and youtube and twitter and stackoverflow and unity3d and github and monogame etc... some cookie investigators might one day exist where you click on a 
//button to accept at sorts of terms none of us take the time to read, and your data goes straight in the pockets of inventors in programming or rich programmers stealing our very hard work done to make things work... and now, they all have the data of our scripts, so how can
//a simple hobbyist programmer that doesn't delete his internet cookies all of the time after browsing for programming references, and always ends up making things work, just as we all do programmers hobbyist or not, always end up being the last one to release his own "programs"
//... wouldn't that be ironic? scripting for 4++ years but always being the last one to use his own creations inside of video games simply because his internet cookies personal data of internet programming browsing and unity3d scripting non-stop for hours and hours on end.
//Cookie investigators, i hope one day those would exist. Litterrally making sense of every godamn line of code and where the "stolen" intellectual property is going... Unless facebook developps it's own department for "credits and inventions" cookie personal data companies
//willing to pay for those cookies... 

//The maze generator youtube tutorial was where i started for the maze. It didn't use negative indexes, and back then, none of the youtubers i learned from used negative indexes to sort through arrays. That maze generator youtube tutorial wasn't an infinite maze generator though
//but i will attempt and find that reference so that i can give the credit to all 4++ of those youtubers. Special thanks also to the the unity3d forums and stackoverflow forums and codeproject and github MIT licensed projects, who inspired me to code something like this.

//But i wanted to have the ability to use negative and positive indexes in order to access arrays... which isn't possible really without
//having a positive number. So i searched a bit stackoverflow and the unity forums and somewhere inside of there it was explained to make the indexes positive when they are negative. but for an infinite terrain, i had to find a way to make it "perpetual" until it breaks. I 
//was inspired to code a script like this in order to make an infinite terrain for void expanse planet missions to generate void expanse decorations/spaceObjects/Crates types of tiles but i hadn't been able to script a successful version of that. but in void expanse, it's 
//hard. i've only found a couple of ways to create terrain in Void Expanse from the Atomic Torch Studios. but in order for the terrain to be "rendered" off and not kill performance, i would have to destroy the
//GameObject every frame. The other only way i have just thought of, is to "teleport/warp the inactive repetitive wall sections somewhere else the player doesn't see". Otherwise, destroy frame by frame objects for a whole server would be a very performance heavy thing to do.
//My pathfinding javascript/ecma5 incorporation of Sebastian Lague's tutorial, was messing up the performance when i wasn't done with learning his tutorial because i wanted the simple version of how pathfinding worked and i cannot use multithreading in JavascriptEcma5 Strict
//I can't multithread in javascriptEcma5 so i had to use a way that involved creating smaller pathfinding tiles with a repetitive pathfind, for small "chunk 2d tiles" that doesn't kill performance so that the pathfind connects "chunks" after "chunks" without killing 
//performance. i hope everyone will like my void expanse 2d pathfind implementation based on Sebastian Lague's tutorial. i paid 1 month of Patreon 20$ way back when, but money started to be hard bringing in on my side so i cancelled that subscription. I hope Sebastian Lague 
//will have more "pathfind students" in the future in order to make him even more popular too and for him to bring in more patreons subscribers. The more he teaches, the more people like me will go learn from that youtube teacher when they will have the time. 

//In JavascriptEcma5, i couldn't use the multithreading of Sebastian Lagues infinite terrain tutorial. My prefered way to go was to try and use what i learned from all 3 of them Holistic3D and Sebastian Lagues and Craig Perkos minecraft 
//tutorial chunk series and make a very cool planet exploration mod for my 9sMods series. but that whole negative index in order to sort terrain index, it was somehow very confusing when i first attempted to do that and i had found no tutorials on stackoverflow post for infinite
//terrain using flat arrays and negative indexes etc and normally, i try and learn from C# and then i try and convert what i learn to javascriptEcma5 in order to make mods for Void Expanse.
//I use a similar way of creating "planets" inside of unity3D which i have posted on my twitter and facebook, and the planet project will be available soon. It's generating quite fast in unity3D but the mountains segments aren't working properly still and i had issues with the 
//destructible bullets to hit the correct "chunk index segments" in my unity3d chunk planet attempts... so for a reduced voxel size of minecraft terrain, i still had issues with the index selection for a "mini minecraft looking" chunk at 0.1 float as size of faces.

//https://www.facebook.com/sccoresystems
//original planet project working in june 2017 https://www.facebook.com/photo.php?fbid=271787936628041&set=pb.100013905109272.-2207520000..&type=3 but it wasn't using a coroutine to draw the terrain, and i modified it a tiny bit.
//https://twitter.com/sccoresystems1/status/1262963819296538630
//my other 2020 voxel destructible planet, where i try and upload some screenshots sometimes but not as often as i should.
...
//The Infinite Terrain logic:
//In order to make infinite terrain work i learned from all 3 Craig Perko Sebastian Lague and Holistic3D of YouTube.
//Craig Perko's https://www.youtube.com/watch?v=YpHQ-Kykp_s&ab_channel=CraigPerko
//Holistic's infinite terrain series is here https://www.youtube.com/watch?v=dycHQFEz8VI&ab_channel=Holistic3d
//Sebastian Lague's infinite terrain series is here https://www.youtube.com/watch?v=wbpMiKiSKm8&list=PLFt_AvWsXl0eBW2EiBtl_sxmDtSgZBxB3&ab_channel=SebastianLague
//negative index for array lookup for easy array sorting. I started using this type of arrays for chunks about at the same that i was testing performance in unity3d for 3d and 2d arrays or 3d and 2d "flat" arrays, and dictionaries and lists, but i've always found arrays to be 
//more performant after i had done a couple of tests a way back when in unity3d C# 2016-2018. 
//There are tons of other ways to do this anyway sorting chunk indexes inside of a 2d or 3d flat array, i am sure of it, but i prefer doing it this way. 
//Flat arrays are explained here https://www.dotnetperls.com/flatten-array
//There might be bugs and if there are, i will correct those bugs when i have a chance.
